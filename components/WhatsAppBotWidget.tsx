...
// ═══════════════════════════════════════════════════════════
// NOVA EPOKSI ANTALYA — FLOATING WHATSAPP ACTION SPHERE (NOVA DIGITAL STYLE)
// ═══════════════════════════════════════════════════════════
...
export default function WhatsAppBotWidget() {
  return (
    <a
      ...
      className="fixed bottom-5 right-4 sm:bottom-7 sm:right-6 z-50 flex items-center justify-center w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white shadow-2xl shadow-[#25D366]/40 transition-all hover:scale-110 active:scale-95 border-2 border-white/30 group cursor-pointer"
    >
