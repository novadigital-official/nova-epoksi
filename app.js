...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const storedTheme = localStorage.getItem('nova_theme') || 'light';
    ...
    const baContainer = document.getElementById('beforeAfterSlider');
    if (baContainer) {
        ...
        updateSliderPosition(baContainer.getBoundingClientRect().left + (baContainer.getBoundingClientRect().width / 2));
    }
