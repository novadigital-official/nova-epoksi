...
export default function AntalyaEpoksiMasterSalesPage() {
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-amber-500 selection:text-slate-950 relative overflow-x-hidden w-full max-w-full">
      ...
      <div className="bg-[#0B1120] text-slate-300 py-2 px-4 text-xs font-mono border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="hidden sm:flex items-center gap-4 text-slate-400">
            ...
            <span>•</span>
            <span className="text-slate-200 font-semibold">0507 087 17 89</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-slate-900 leading-[1.12] tracking-tight">
              Fabrika, Depo ve Tesisler İçin <span className="text-amber-600">Yüksek Mukavemetli</span> Epoksi Zemin Çözümleri
            </h1>
            
            {/* SUBTITLE */}
            <p className="text-slate-600 text-sm sm:text-base md:text-lg font-normal leading-relaxed max-w-2xl">
              Antalya OSB ve ticari işletmeler için lazerli nem analizi, elmas silim zemin hazırlığı ve ağır forklift dayanımlı çok katmanlı epoksi uygulamaları. <strong className="text-slate-900 font-semibold">200 TL/m²'den başlayan sözleşmeli fiyatlar.</strong>
            </p>

            {/* 4 SPECIFICATION CARDS (2x2 GRID) */}
            <div className="grid grid-cols-2 gap-3 text-xs sm:text-sm font-semibold text-slate-800">
              <div className="flex items-center gap-2.5 bg-white border border-slate-200/90 p-3.5 rounded-2xl shadow-2xs">
                <svg className="w-4 h-4 stroke-current text-amber-600 fill-none stroke-2 shrink-0" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-1">
              <a
                ...
                className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-heading font-bold px-7 py-3.5 min-h-[50px] rounded-2xl text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-sm cursor-pointer transition-all hover:scale-102 active:scale-98"
              >
                <span>Ücretsiz Keşif Randevusu Al</span>
              </a>
              <a
                href="tel:05070871789"
                className="bg-slate-900 hover:bg-slate-800 text-white font-heading font-semibold px-6 py-3.5 min-h-[50px] rounded-2xl text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-sm"
              >
      ...
      <section className="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
          <div className="metric-dash-card">
            <div className="font-mono text-3xl sm:text-4xl font-extrabold text-slate-900 mb-1">
              50+
            </div>
          ...
          <div className="metric-dash-card">
            <div className="font-mono text-3xl sm:text-4xl font-extrabold text-slate-900 mb-1">
              15.000+ <span className="text-base font-medium text-slate-400">m²</span>
            </div>
            <div className="text-xs font-heading font-bold text-slate-900 uppercase tracking-wider">
      ...
      {/* 5. TAMAMLANAN SAHA PROJELERİ & REFERANSLAR */}
      ...
      <section className="py-12 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-slate-200/90">
        <div className="text-center max-w-3xl mx-auto space-y-2 mb-8 sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-extrabold text-slate-900 tracking-tight">
            Neden Nova Epoksi? (Kalite & Güvence)
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-5xl mx-auto">
          <div className="bg-white border-2 border-slate-900 p-6 sm:p-7 rounded-3xl shadow-2xs space-y-4">
            <div className="flex items-center gap-2 text-slate-900 font-heading font-bold text-sm sm:text-base uppercase">
              <svg className="w-5 h-5 stroke-current text-amber-600 fill-none stroke-2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
              </svg>
              <span>NOVA EPOKSİ SİSTEMLERİ</span>
            </div>
            <ul className="space-y-3 text-xs sm:text-sm font-medium text-slate-700">
              <li className="flex items-start gap-2.5">
                <svg className="w-4 h-4 stroke-current text-amber-600 fill-none stroke-2 shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
          ...
          <div className="bg-slate-50 border border-slate-200 p-6 sm:p-7 rounded-3xl text-slate-500 space-y-4">
            <div className="flex items-center gap-2 text-slate-600 font-heading font-semibold text-sm sm:text-base uppercase">
              <svg className="w-5 h-5 stroke-current text-slate-400 fill-none stroke-2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
              </svg>
              <span>Standart Serbest Ustalar</span>
            </div>
            <ul className="space-y-3 text-xs sm:text-sm font-normal text-slate-500">
              <li className="flex items-start gap-2.5">
                <svg className="w-4 h-4 stroke-current text-slate-400 fill-none stroke-2 shrink-0 mt-0.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
      ...
      <section className="py-12 sm:py-16 bg-white border-t border-slate-200/90">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center max-w-3xl mx-auto space-y-2">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-heading font-semibold bg-slate-100 text-slate-700 uppercase tracking-wider">
              <span>Doğrulanmış Saha Referansları</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-extrabold text-slate-900 tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-6xl mx-auto">
            <div className="bg-slate-50 border border-slate-200 p-6 rounded-3xl space-y-3">
              <div className="text-amber-600 font-bold text-xs">5.0 / 5.0 — Onaylı Proje</div>
              ...
              <div className="pt-2 border-t border-slate-200/80">
                <div className="font-heading font-bold text-xs text-slate-900">Mustafa K.</div>
            ...
            <div className="bg-slate-50 border border-slate-200 p-6 rounded-3xl space-y-3">
              ...
              <div className="pt-2 border-t border-slate-200/80">
                <div className="font-heading font-bold text-xs text-slate-900">Serkan Y.</div>
            ...
            <div className="bg-slate-50 border border-slate-200 p-6 rounded-3xl space-y-3">
              ...
              <div className="pt-2 border-t border-slate-200/80">
                <div className="font-heading font-bold text-xs text-slate-900">Engin B.</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-b border-slate-800 pb-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-heading font-bold px-4 py-2.5 rounded-xl text-xs transition-all shadow-sm"
              >
                Mühendis Danışma Hattı
              </a>
            </div>
          </div>
          
          <div className="flex flex-wrap justify-center md:justify-start gap-4 font-semibold text-slate-300 text-xs">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 font-mono gap-3 pt-4 border-t border-slate-900">
            ...
            <div className="flex gap-4">
              ...
              <a href="/admin/dashboard" className="text-slate-400 hover:text-slate-200 font-semibold">
                Yönetici Paneli
              </a>
            </div>
          </div>
