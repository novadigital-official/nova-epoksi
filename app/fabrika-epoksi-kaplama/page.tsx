...
export const metadata: Metadata = {
  title: 'Antalya Fabrika Epoksi Zemin Kaplama | Nova Epoksi',
  description: 'Döşemealtı OSB ve Antalya fabrika zemin kaplama. Forklift ve ağır yük garantili multilayer epoksi çözümleri.',
  keywords: ['fabrika epoksi antalya', 'depo zemin kaplama antalya', 'döşemealtı osb epoksi']
};

export default function FabrikaEpoksiPage() {
  return (
      ...
      <header className="sticky top-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-slate-800 py-4 px-4 sm:px-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[10px] text-slate-400 font-bold uppercase">ENDÜSTRİYEL FABRİKA ZEMİN SİSTEMLERİ</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-black bg-orange-500/10 text-orange-400 border border-orange-500/30 mb-4">
              🏭 AĞIR SANAYİ VE FABRİKA UZMANI
            </span>
            <h1 className="text-3xl sm:text-5xl font-black text-white leading-tight mb-4">
              Antalya Fabrika & Depo <span className="text-orange-500">Ağır Yük Epoksi</span> Kaplama
            </h1>
            <p className="text-slate-300 text-base sm:text-lg mb-6 leading-relaxed">
              Forklift trafiğine, kimyasal dökülmelere ve aşınmaya son veren 3mm kaymaz multilayer epoksi zemin kaplama.
            </p>
          </div>
